      ...
      <section className="relative bg-[#C9A84C] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 pt-36 lg:pt-44 pb-32 lg:pb-40">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6">
            <span className="text-[#0B1F3A]">Income Tax Notices</span>
            <br />
            <span className="text-white">& Disputes</span>
          </h1>
          <p className="text-xl max-w-3xl leading-relaxed text-[#0B1F3A]/60 font-light">
            Notice to CIT(A), ITAT, High Court, and Supreme Court — CA-led responses, hearings, and appeals.
          </p>
        </div>
      ...
      <section className="relative bg-white py-20 lg:py-28 px-6 lg:px-10">
        <div className="max-w-[1400px] mx-auto">
          <p className="text-lg leading-relaxed mb-16 text-[#3D5A80]">
            A notice does not automatically mean wrongdoing — the Department issues them for verification, scrutiny, reassessment, demands, and more. What matters is a timely, well-documented response. AnyTax.in&apos;s litigation team provides end-to-end representation from initial reply through CIT(A), ITAT, High Court, and Supreme Court, including rectification, stay of demand, and revision matters.
          </p>
      ...
      <section className="relative bg-[#C9A84C] py-28 lg:py-36 px-6 lg:px-10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto text-center">
          <h2 className="text-4xl lg:text-5xl font-bold tracking-tight text-[#0B1F3A] mb-6 leading-tight">
            Received a <span className="text-white">Tax Notice?</span>
          </h2>
