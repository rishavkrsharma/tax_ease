      ...
      <section className="relative bg-[#C9A84C] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 pt-36 lg:pt-44 pb-32 lg:pb-40">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6">
            <span className="text-[#0B1F3A]">International</span>
            <br />
            <span className="text-white">Taxation</span>
          </h1>
          <p className="text-xl max-w-2xl leading-relaxed text-[#0B1F3A]/55 font-light">
            DTAAs, Sections 5/6/9/195, FEMA reporting, equalisation levy, and POEM — for NRIs and cross-border groups.
          </p>
        </div>
      ...
      <section className="bg-white py-20 lg:py-28 px-6 lg:px-10">
        <div className="max-w-[1400px] mx-auto">
          <p className="text-lg text-[#3D5A80] leading-relaxed mb-14 max-w-4xl mx-auto text-center">
            India&apos;s treaty network and domestic non-resident provisions require coordinated advice. We support NRI residency and sourcing, Section 195 withholding, inbound FDI structuring, outbound investment reporting, equalisation levy on digital supplies, POEM risk, and FATCA/CRS obligations for financial institutions.
          </p>
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0B1F3A] tracking-tight">
              International Tax <span className="text-[#C9A84C]">Solutions</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-5">
            {[
              {
                title: "NRI Taxation",
                desc: "Comprehensive tax advisory for Non-Resident Indians",
                icon: "🌐",
                items: ["Residential status determination", "Income taxation in India", "Investments in India", "Property transactions", "Fund repatriation", "Tax return filing"]
              },
              {
                title: "DTAA Advisory",
                desc: "Double Taxation Avoidance Agreement optimization",
                icon: "📜",
                items: ["Treaty benefit analysis", "Tax residency certificates", "Lower withholding tax", "Permanent Establishment issues", "Mutual Agreement Procedure", "Dispute resolution"]
              },
              {
                title: "Foreign Investments",
                desc: "Inbound and outbound investment structuring",
                icon: "🌍",
                items: ["FDI compliance", "ODI planning & approval", "FEMA compliance", "Cross-border remittances", "Loan transactions", "Equity investments"]
              },
              {
                title: "Global Tax Structuring",
                desc: "International tax planning and optimization",
                icon: "🏛️",
                items: ["Holding structures", "IP migration planning", "Fund structuring", "Tax efficient routing", "BEPS compliance", "MLI impact assessment"]
              }
            ].map((service, idx) => (
      ...
      <section className="relative bg-[#0B1F3A] py-20 lg:py-28 px-6 lg:px-10 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto pt-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: "International Specialists", desc: "Dedicated team with deep expertise in cross-border taxation", icon: "🏆" },
              { title: "Global Perspective", desc: "Understanding of tax regimes across major jurisdictions worldwide", icon: "🌐" },
              { title: "Treaty Expertise", desc: "In-depth knowledge of DTAA with 90+ countries for optimal benefits", icon: "📜" },
              { title: "FEMA Compliance", desc: "End-to-end FEMA compliance for foreign exchange transactions", icon: "⚖️" },
              { title: "Regulatory Updates", desc: "Stay ahead with the latest changes in international tax laws", icon: "📊" },
              { title: "Comprehensive Solutions", desc: "One-stop advisory for all cross-border taxation needs", icon: "🎯" }
            ].map((item, idx) => (
      ...
      <section className="bg-white py-20 lg:py-28 px-6 lg:px-10">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0B1F3A] tracking-tight">
              Key Areas of <span className="text-[#C9A84C]">Expertise</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FDFBF6] rounded-[28px] p-8 border border-[#E2DFD6]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-bold text-[#0B1F3A]">Inbound Transactions</h3>
              </div>
              <ul className="space-y-3">
                {["Foreign company taxation in India", "Branch / Project Office setup", "Withholding tax on payments to non-residents", "Transfer pricing compliance", "Permanent Establishment analysis"].map((item, i) => (
            ...
            <div className="bg-[#FDFBF6] rounded-[28px] p-8 border border-[#E2DFD6]">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-full bg-[#C9A84C]/10 flex items-center justify-center text-lg">🚀</div>
                <h3 className="text-lg font-bold text-[#0B1F3A]">Outbound Transactions</h3>
              </div>
              <ul className="space-y-3">
                {["Indian company global expansion", "Overseas subsidiary setup", "Profit repatriation strategies", "Foreign tax credit optimization", "GAAR & SAAR considerations"].map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <span className="text-[#C9A84C] text-sm mt-0.5 flex-shrink-0">✓</span>
                    <span className="text-sm text-[#3D5A80]">{item}</span>
                  </li>
      ...
      <section className="relative bg-[#C9A84C] py-28 lg:py-36 px-6 lg:px-10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto text-center">
          <h2 className="text-4xl lg:text-5xl font-bold tracking-tight text-[#0B1F3A] mb-6 leading-tight">
            Need International{' '}
            <span className="text-white">Tax Advisory?</span>
          </h2>
          <p className="text-lg text-[#0B1F3A]/55 font-light mb-10 max-w-2xl mx-auto">
            Expert guidance on cross-border taxation, NRI tax planning, and global structuring
          </p>
